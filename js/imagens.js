...
(function (global) {
  ...
  /* Quanto tempo esperar o navegador dizer que o elemento está à vista
     antes de pedir assim mesmo. Pedir primeiro o que aparece na tela é
     OTIMIZAÇÃO; a imagem chegar é requisito. Há navegador e há situação
     (aba em segundo plano, página que ainda não foi pintada) em que o
     aviso não vem nunca — e sem esta espera a imagem não apareceria
     jamais. */
  var ESPERA_SEM_AVISO_MS = 1200;
  ...
  function aplicar(caixa, opcoes) {
    ...
    relogio = setTimeout(pedirUmaVez, ESPERA_SEM_AVISO_MS);
